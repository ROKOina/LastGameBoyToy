...
CEREAL_CLASS_VERSION(ParticleSystemCom::ScaleLifeTimeA, 1)
CEREAL_CLASS_VERSION(ParticleSystemCom::ColorLifeTime, 1)
CEREAL_CLASS_VERSION(ParticleSystemCom::RotationLifeTime, 1)
CEREAL_CLASS_VERSION(ParticleSystemCom::ParticleConstantsA, 1)
CEREAL_CLASS_VERSION(ParticleSystemCom::ParticleConstants, 1)
CEREAL_CLASS_VERSION(ParticleSystemCom::SaveParticleDataA, 1)
...
template<class Archive>
void ParticleSystemCom::ScaleLifeTimeA::serialize(Archive& archive, int version)
{
	archive(
		CEREAL_NVP(keyTime),
		CEREAL_NVP(sDummy),
...
template<class Archive>
void ParticleSystemCom::ParticleConstantsA::serialize(Archive& archive, int version)
{
	archive(
		CEREAL_NVP(isWorld),
		CEREAL_NVP(isRoop),
...
template<class Archive>
void ParticleSystemCom::SaveParticleDataA::serialize(Archive& archive, int version)
{
	archive(
...
void ParticleSystemCom::OnGUI()
{
	...
	//サイズ
	{
		...
		if (isRan)
		{
			ImGui::DragFloat2("startSizeRand", &particleData_.particleData.startSize.y, 0.01f, 0.01f, 100);
		}
	}
...
void ParticleSystemCom::DeleteScaleKey(int id, ScaleLifeTime(&scaleLife)[scaleKeyCount])
{
	...
	scaleLife[id].value = { 1,1 };
	scaleLife[id].curvePower = { 1,1 };
	...
	for (int i = id; i < scaleKeyCount - 1; ++i)
	{
		...
		if (scaleLife[i + 1].keyTime < 0)
		{
			...
			scaleLife[i].value = { 1,1 };
			scaleLife[i].curvePower = { 1,1 };
		...
		if (id == scaleKeyCount - 2)
		{
			...
			scaleLife[i + 1].value = { 1,1 };
			scaleLife[i + 1].curvePower = { 1,1 };
...
ParticleSystemCom::SaveParticleData ParticleSystemCom::LoadParticle(const char* filename)
{
	...
	//フォーマット変更時
	{
		particleData_.particleTexture = particleDataA_.particleTexture;
		particleData_.particleData.color = particleDataA_.particleData.color;
		for (int i = 0; i < 5; ++i)
			particleData_.particleData.colorLifeTime[i] = particleDataA_.particleData.colorLifeTime[i];
		particleData_.particleData.emitterPosition = particleDataA_.particleData.emitterPosition;
		particleData_.particleData.gravity = particleDataA_.particleData.gravity;
		particleData_.particleData.isRoop = particleDataA_.particleData.isRoop;
		particleData_.particleData.isWorld = particleDataA_.particleData.isWorld;
		particleData_.particleData.lifeTime = particleDataA_.particleData.lifeTime;
		particleData_.particleData.rateTime = particleDataA_.particleData.rateTime;
		particleData_.particleData.rotationLifeTime = particleDataA_.particleData.rotationLifeTime;
		for (int i = 0; i < 5; ++i)
		{
			particleData_.particleData.scaleLifeTime[i].curvePower = { particleDataA_.particleData.scaleLifeTime[i].curvePower ,particleDataA_.particleData.scaleLifeTime[i].curvePower };
			particleData_.particleData.scaleLifeTime[i].keyTime = particleDataA_.particleData.scaleLifeTime[i].keyTime;
			particleData_.particleData.scaleLifeTime[i].value = { particleDataA_.particleData.scaleLifeTime[i].value,particleDataA_.particleData.scaleLifeTime[i].value };
			particleData_.particleData.scaleLifeTimeRand[i].curvePower = { particleDataA_.particleData.scaleLifeTimeRand[i].curvePower ,particleDataA_.particleData.scaleLifeTimeRand[i].curvePower };
			particleData_.particleData.scaleLifeTimeRand[i].keyTime = particleDataA_.particleData.scaleLifeTimeRand[i].keyTime;
			particleData_.particleData.scaleLifeTimeRand[i].value = { particleDataA_.particleData.scaleLifeTimeRand[i].value,particleDataA_.particleData.scaleLifeTimeRand[i].value };
		}
		particleData_.particleData.shape = particleDataA_.particleData.shape;
		particleData_.particleData.startAngle = particleDataA_.particleData.startAngle;
		particleData_.particleData.startAngleRand = particleDataA_.particleData.startAngleRand;
		particleData_.particleData.startSize.x = particleDataA_.particleData.startSize.x;
		particleData_.particleData.startSize.y = particleDataA_.particleData.startSize.x;
		particleData_.particleData.startSize.z = particleDataA_.particleData.startSize.y;
		particleData_.particleData.startSize.w = particleDataA_.particleData.startSize.y;
		particleData_.particleData.startSizeRandom = particleDataA_.particleData.startSize.w;
		particleData_.particleData.startSpeed = particleDataA_.particleData.startSpeed;
		particleData_.particleData.uv = particleDataA_.particleData.uv;
		particleData_.particleData.velocityLifeTime = particleDataA_.particleData.velocityLifeTime;
	}

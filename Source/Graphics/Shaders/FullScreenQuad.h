...
public:
    ...
    ID3D11ShaderResourceView** GetCachedShaderResourceViews() { return m_cachedShaderResourceViews; }
...
private:
    ...
    // キャッシュされたリソースビュー
    ID3D11ShaderResourceView* m_cachedShaderResourceViews[D3D11_COMMONSHADER_INPUT_RESOURCE_SLOT_COUNT]{};
};
...
void TutorialSystem::MoveTutorialManager(float elapsedTime)
{
    if (!linesFlag)
    {
        Audio2DMagaer::Instance().Audio2DPlay(moveSubTitle[moveSubTitleIndex].Lines, false, 1.0f);
...
void TutorialSystem::GunTutorialManager(float elapsedTime)
{
    if (!linesFlag)
    {
        Audio2DMagaer::Instance().Audio2DPlay(gunSubTitle[gunSubTitleIndex].Lines, false, 1.0f);
        linesFlag = true;
    }
...
void TutorialSystem::SkillTutorialManager(float elapsedTime)
{
    if (!linesFlag)
    {
        Audio2DMagaer::Instance().Audio2DPlay(skillSubTitle[skillSubTitleIndex].Lines, false, 1.0f);
        linesFlag = true;
    }
...
void TutorialSystem::UltTutorialManager(float elapsedTime)
{
    if (!linesFlag)
    {
        Audio2DMagaer::Instance().Audio2DPlay(ultSubTitle[ultSubTitleIndex].Lines, false, 1.0f);
        linesFlag = true;
    }
